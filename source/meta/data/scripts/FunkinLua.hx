...
class FunkinLua {
	...
	public function new(script:String, ?scriptCode:String) {
		...
		Lua_helper.add_callback(lua, "startDialogue", function(dialogueFile:String, music:String = null) {
			...
			#end
			{
				var shit:DialogueFile = DialogueBoxPsych.parseDialogue(SUtil.getPath + path);
		...
		// misc things
		Lua_helper.add_callback(lua, "borderlessWindow", (which:Bool) -> {
			return lime.app.Application.current.window.borderless = which;
		});
